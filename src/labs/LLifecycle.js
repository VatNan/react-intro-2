...
class LogEvery extends Component {
  ...
  componentWillReceiveProps() {
    console.log('%c method lifecycle: componentWillReceiveProps',LOG_FONT_GREEN);
  }
  ...
  render() {
    console.log('%c method lifecycle: render', LOG_FONT_GREEN);
    return (
      <div>
        <button
        ...
        >
          <span style={{ fontSize: '25px' }}>update  state</span> {' '}
          in LogOnly component
        </button>
        <p>{'currnet props => countOuterClick = ' + this.props.countOuterClick}</p>
        <p>{'current state => countInnerClick = ' + this.state.countInnerClick}</p>
      </div>
    );
  }
}
  ...
  render() {
    return (
      <div>
        ...
        >
          <span style={{ fontSize: '25px' }}>update props </span> {' '}
          to LogEvery component
        </button>
